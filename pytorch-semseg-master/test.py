...
if __name__ == "__main__":
    ...
    parser.add_argument(
        ...
        nargs="?",
        type=str,
        default="E:/Autopilot/pytorch-semseg-master/runs/custom/40609/fcn8s_camvid_best_model.pkl",
    ...
    parser.add_argument(
        "--img_path", nargs="?", type=str, default='E:/Autopilot/3.png'
    )
    parser.add_argument(
        "--out_path", nargs="?", type=str, default='E:/Autopilot/3r.png'
    )
